...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_z1fi42r', 'template_32ztifo', form.current, 'vMB8W6DDo_gE8I-9M')
      e.target.reset()
  };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <a href="https://api.whatsapp.com/send ? phone=123456789&text=Hello, more information!" className="contact__button">Write me{" "}
                        <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">user.Insta123</span>
